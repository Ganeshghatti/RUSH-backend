...
import { patientOnboard, getPatientDashboard, getAppointmentsDoctorForPatient, updateHealthMetrics, getHealthMetrics, updateBankDetail, updatePersonalInfo } from "../../controller/patient/patient";
