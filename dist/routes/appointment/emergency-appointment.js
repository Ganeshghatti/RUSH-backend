...
const create_emergency_token_1 = require("../../controller/appointment/create-emergency-token");
...
router.route("/appointment/emergency/token")
    .post(auth_middleware_1.verifyToken, create_emergency_token_1.createEmergencyRoomAccessToken);
