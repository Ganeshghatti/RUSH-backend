...
const appointment_1 = __importDefault(require("./routes/appointment/appointment"));
...
app.use("/symptom", symptom_route_1.default);
app.use("/appointment", appointment_1.default);
app.use("/online-appointment", online_appointment_1.default);
app.use("/emergency-appointment", emergency_appointment_1.default);
app.use("/clinic-appointment", clinic_appointment_1.default);
app.use("/home-visit-appointment", homevisit_appointment_1.default);
