...
const PatientSubscriptionSchema = new mongoose_1.Schema({
    price: {
        type: Number,
...
const PatientSubscription = mongoose_1.default.model("PatientSubscription", PatientSubscriptionSchema);
exports.default = PatientSubscription;
